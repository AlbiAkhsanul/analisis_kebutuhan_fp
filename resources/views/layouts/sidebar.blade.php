<div class="col-lg-2 mt-4 text-white p-2 border-end" style="min-height: 80vh;">
    <div class="text-start ms-3 mb-3 mt-3">
        <img src="{{ $user->foto_pengguna ?? asset('src/defaultPfp.jpg') }}" alt="Foto Pengguna" class="rounded-circle" width="100" style="border-radius: 121px; border: 5px white solid" src="https://placehold.co/100x100">
    </div>
